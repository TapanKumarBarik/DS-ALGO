 ...
 * 
 * Given an array of words A of size N written in the alien language, and the
 * order of the alphabet denoted by string B of size 26, return 1 if and only if
 * the given words are sorted lexicographically in this alien language else,
 * return 0.
 * 
 * 
 * 
 ...
 * 
 * Output Format
 * Return 1 if and only if the given words are sorted lexicographically in this
...
public class Solution {
    public int solve(String[] A, String B) {
        ...
        for (int i = 0; i < m - 1; i++) {
            ...
            for (int j = 0; j < Math.min(num1, num2); j++) {
