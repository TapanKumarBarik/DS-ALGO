 ...
 * 
 * The first element of the subsequence is odd; the second element is even, the
 * third element is odd, and so on. For example: [5, 10, 5, 2, 1, 4], [1, 2, 3,
 * 4, 5]
 * 
 * The first element of the subsequence is even, the second element is odd, the
 * third element is even, and so on. For example: [10, 5, 2, 1, 4, 7], [10, 1,
 * 2, 3, 4]
 * 
