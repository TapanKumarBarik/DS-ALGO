 ...
 * 
 * Output Format
 * Return an array(0 based indexing) that stores the total number of coins in
 * each beggars pot.
 * 
 * 
 * Example Input
 ...
 * Example Explanation
 * Explanation 1:-
 * First devotee donated 10 coins to beggars ranging from 1 to 2. Final amount
 * in each beggars pot after first devotee: [10, 10, 0, 0, 0]
 * Second devotee donated 20 coins to beggars ranging from 2 to 3. Final amount
 * in each beggars pot after second devotee: [10, 30, 20, 0, 0]
 * Third devotee donated 25 coins to beggars ranging from 2 to 5. Final amount
 * in each beggars pot after third devotee: [10, 55, 45, 25, 25]
 * 
 */
